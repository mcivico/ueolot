...
public class Noticies_1E_Task extends AsyncTask<String, Void, Integer> {

    public InputStream contingut = null;
    public Noticies_1E_Response resp_noticies;
    public Fragment_llista_noticies_primerEquip fragment;

    public Noticies_1E_Task(Fragment_llista_noticies_primerEquip fragment){this.fragment = fragment;}
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try{
            ...
            if(status == 200){
                ...
                resp_noticies = new Gson().fromJson(json,Noticies_1E_Response.class);
                String a = "";
            }
