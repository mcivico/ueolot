...
public class Next_Resultado_Task extends AsyncTask<String, Void, Integer> {

    public InputStream contingut = null;
    public Next_Resultado_Response response;
    public Fragment_Llista_Noticia fragment;

    public Next_Resultado_Task(Fragment_Llista_Noticia fragment){this.fragment = fragment;}
    ...
    protected Integer doInBackground(String... strings) {
        ...
        int status = -1;
        try{
            URL u = new URL("http://www.ueolot.com/app/webservices/next-resultado.php");
            ...
            if(status == 200){
                ...
                response = new Gson().fromJson(json, Next_Resultado_Response.class);
                String a = "";
            }
    ...
    protected void onPostExecute(Integer result) {
        ...
        this.fragment.carregar_dades3(response.resultado);
