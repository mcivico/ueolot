...
/**
 * Created by m_civico on 22/09/2016.
 */
public class Adapter_Player extends ArrayAdapter<Player> {
    ...
    public Adapter_Player(Activity context, ArrayList<Player> dades){
        super(context, R.layout.fragment_adapter_player,dades);
        this.dades = dades;
    }
